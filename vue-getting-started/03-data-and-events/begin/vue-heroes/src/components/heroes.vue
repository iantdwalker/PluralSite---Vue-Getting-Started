      ...
      <div class="column is-8">
        <div class="card edit-detail">
          ...
          <div class="card-content">
            <div class="content">
              ...
              <div class="field">
                ...
                <div
                  class="color-line"
                  :style="{ 'background-color': hero.capeColour }"
                ></div>
              </div>
              <div class="field">
                <label for="power">
          ...
          <footer class="card-footer">
            ...
            <button @click="saveHero('my hero:')" class="link card-footer-item">
...
export default {
  ...
  methods: {
    ...
    saveHero(value) {
      this.message = value + JSON.stringify(this.hero, null, '\n');
    },
    clearPower() {
      this.hero.power = '';
    },
